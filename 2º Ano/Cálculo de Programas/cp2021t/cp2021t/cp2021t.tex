...
\ensuremath{\Conid{X}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{Bin}\mathbin{+}\Conid{Un})))}. As expressões obtidas do outExpAr refletem esse mesmo aninhamento no que toca às injeções i1 e i2. Em relação à função recExpAr o grupo
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{ExpAr}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{eval\char95 exp}\;\Varid{x}}}
...
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{BinOp}\times(\Conid{ExpAr}\;\Conid{A}\times\Conid{ExpAr}\;\Conid{A})\mathbin{+}\Conid{UnOp}\times\Conid{ExpAr}\;\Conid{A}))}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{eval\char95 exp}\;\Varid{x}\times\Varid{eval\char95 exp}\;\Varid{x})\mathbin{+}\Varid{id}\times\Varid{eval\char95 exp}\;\Varid{x}))}}
\\
     \ensuremath{\Conid{A}}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{BinOp}\times(\Conid{A}\times\Conid{A})\mathbin{+}\Conid{UnOp}\times\Conid{A}))}
           \ar[l]^-{\ensuremath{\Varid{g\char95 eval\char95 exp}\;\Varid{x}}}
}
\end{eqnarray*}
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\alt{\Varid{g1}}{\alt{\Varid{g2}}{\alt{\Varid{g3}}{\Varid{g4}}}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\mathrel{=}\underline{\Varid{a}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;\Varid{a}\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Sum},(\Varid{a},\Varid{b}))\mathrel{=}\Varid{a}\mathbin{+}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Product},(\Varid{a},\Varid{b}))\mathrel{=}\Varid{a}\mathbin{*}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g4}\;(\Conid{Negate},\Varid{a})\mathrel{=}\Varid{negate}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g4}\;(\Conid{E},\Varid{a})\mathrel{=}\Varid{expd}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
O clean e o gopt são dois genes que necessitamos deduzir. O gopt é o gene de um catamorfismo, sendo que pode ser igual ao \ensuremath{\Varid{g\char95 eval\char95 exp}}, já o clean, que é o gene do
...
\\
\>[B]{}\Varid{clean}\mathrel{=}\Varid{outExpAr}\comp \alt{\Varid{g1}}{\alt{\Varid{g2}}{\alt{\Varid{g3}}{\Varid{g4}}}}\comp \Varid{outExpAr}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\mathrel{=}\underline{\Conid{X}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\mathrel{=}\Conid{N}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Product},(\Conid{N}\;\mathrm{0},\Varid{b}))\mathrel{=}\Conid{N}\;\mathrm{0}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Product},(\Varid{a},\Conid{N}\;\mathrm{0}))\mathrel{=}\Conid{N}\;\mathrm{0}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Sum},(\Varid{a},\Conid{N}\;\mathrm{0}))\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Sum},(\Conid{N}\;\mathrm{0},\Varid{b}))\mathrel{=}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Varid{op},(\Varid{a},\Varid{b}))\mathrel{=}\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g4}\;(\Varid{op},\Varid{a})\mathrel{=}\Conid{Un}\;\Varid{op}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
...
\ColumnHook
\end{hscode}\resethooks
Tendo em conta que a função sd recebe um ExpAr e devolve um outro, e considerando o tipo já definido do gene do catamorfismo \ensuremath{\Varid{sd\char95 gen}}, foi
...
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\conj{\Varid{fun}}{\Varid{deriv}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{fun}\mathrel{=}\alt{\Varid{g1}}{\alt{\Varid{g2}}{\alt{\Varid{g3}}{\Varid{g4}}}}\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{g1}\mathrel{=}\underline{\Conid{X}}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{g2}\mathrel{=}\Conid{N}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{g3}\;(\Varid{binop},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Bin}\;\Varid{binop}\;\Varid{a}\;\Varid{c}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{g4}\;(\Varid{unop},(\Varid{a},\Varid{b}))\mathrel{=}\Conid{Un}\;\Varid{unop}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{deriv}\mathrel{=}\alt{\Varid{g1}}{\alt{\Varid{g2}}{\alt{\Varid{g3}}{\Varid{g4}}}}\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{g1}\mathrel{=}\underline{(\Conid{N}\;\mathrm{1})}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{g2}\mathrel{=}\underline{(\Conid{N}\;\mathrm{0})}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{g3}\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Bin}\;\Conid{Sum}\;\Varid{b}\;\Varid{d}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{g3}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{d})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b}\;\Varid{c}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{g4}\;(\Conid{E},(\Varid{a},\Varid{b}))\mathrel{=}\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{a})\;\Varid{b}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{g4}\;(\Conid{Negate},(\Varid{a},\Varid{b}))\mathrel{=}\Conid{Un}\;\Conid{Negate}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
alínea anterior, devido ao tipo de \ensuremath{\Varid{ad}}, que agora deverá devolver apenas \ensuremath{\Varid{a}} (neste caso um número), enquanto que no anterior todas as operações 
...
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{g1}{}\<[13]%
\>[13]{}\mathrel{=}\underline{(\Varid{v},\mathrm{1})}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{g2}\;\Varid{a}\mathrel{=}(\Varid{a},\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{g3}\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{a}\mathbin{+}\Varid{c},\Varid{b}\mathbin{+}\Varid{d}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{g3}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{a}\mathbin{*}\Varid{c},(\Varid{a}\mathbin{*}\Varid{d})\mathbin{+}(\Varid{b}\mathbin{*}\Varid{c})){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{g4}\;(\Conid{Negate},(\Varid{a},\Varid{b}))\mathrel{=}(\Varid{negate}\;\Varid{a},\Varid{negate}\;\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{g4}\;(\Conid{E},(\Varid{a},\Varid{b}))\mathrel{=}(\Varid{expd}\;\Varid{a},\Varid{b}\mathbin{*}(\Varid{expd}\;\Varid{a})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{loop}\;(\Varid{cat},\Varid{c},\Varid{b})\mathrel{=}(\Varid{cat}\mathbin{*}\Varid{c}\mathbin{\Varid{`div`}}\Varid{b},\Varid{c}\mathbin{+}\mathrm{4},\Varid{b}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{2},\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{prj}\;(\Varid{cat},\Varid{c},\Varid{b})\mathrel{=}\Varid{cat}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}\;{}\<[21]%
\>[21]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;()\mathrel{=}\underline{\Varid{nil}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(\Varid{a},\Varid{b})\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{nil}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(\Varid{a},\Varid{b})\;(\Varid{c}\mathbin{:}\Varid{cs})\mathrel{=}\Varid{z1}\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{4}{}\<[7]%
\>[7]{}\Varid{z1}\;\Varid{z}\mathrel{=}\Varid{concat}\mathbin{\$}\Varid{sequenceA}\;[\mskip1.5mu \Varid{singl}\comp \Varid{linear1d}\;\Varid{a}\;\Varid{c},\Varid{b}\;\Varid{cs}\mskip1.5mu]\;\Varid{z}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{coalg}\mathrel{=}\bot \mbox{\onelinecomment either g1 g2  where               ----- coalg é anaformismo ,    alg é catamorfismo }{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  g1 () = nil}{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  g1 [p] =  i1 . p}{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  g2 l = i1 . i2 l }{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{alg}\mathrel{=}\bot \mbox{\onelinecomment either j1 j2 where}{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  j1 () = nil}{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  j2 [p] = const p}{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  j2 (p,q) l = \pt -> (calcLine (p pt) (q pt)) pt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloAlgForm}\mathrel{=}\bot \mbox{\onelinecomment  alg . coalg }{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Prova avg\_aux:
\item \ensuremath{\Varid{avg\char95 aux}\mathrel{=}\cata{\alt{\Varid{b}}{\Varid{q}}}} \par
\item \equiv \ensuremath{\{\mskip1.5mu \Varid{avg\char95 aux}\mathrel{=}\conj{\Varid{avg}}{\length }\mskip1.5mu\}}\par
\item \ensuremath{\conj{\Varid{avg}}{\Varid{lenth}}\mathrel{=}\cata{\alt{\Varid{b}}{\Varid{q}}}}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Inferir}\;\Varid{tipo}\;\Varid{de}\;\Varid{b}\;\Varid{e}\;\Varid{q}\mskip1.5mu\}}\par
\item  \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\alt{\conj{\Varid{b1}}{\Varid{b2}}}{\conj{\Varid{q1}}{\Varid{q2}}}}}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Lei}\;\Varid{da}\;\Varid{troca}\mskip1.5mu\}}\par
\item  \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\conj{\alt{\Varid{b1}}{\Varid{q1}}}{\alt{\Varid{b1}}{\Varid{q2}}}}}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Fokkinga}\mskip1.5mu\}}\par
\item  \ensuremath{\Varid{avg}\comp \mathbf{in}\mathrel{=}\alt{\Varid{b1}}{\Varid{q1}}\comp \Conid{F}\;\conj{\Varid{avg}}{\length }}\par
\item  \ensuremath{\length \comp \mathbf{in}\mathrel{=}\alt{\Varid{b2}}{\Varid{q2}}\comp \Conid{F}\;\conj{\Varid{avg}}{\length }}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Listas}\mathbin{:}\Conid{F}\;\Varid{f}\mathrel{=}\Varid{id}\mathbin{+}\Varid{id}\;\Varid{f}\mskip1.5mu\}}\par
\item \ensuremath{\Varid{avg}\comp \mathbf{in}\mathrel{=}\alt{\Varid{b1}}{\Varid{q1}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length })}\par
\item \ensuremath{\length \comp \mathbf{in}\mathrel{=}\alt{\Varid{b2}}{\Varid{q2}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length })}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \mathbf{in}\mathrel{=}\alt{\Varid{singl}}{\Varid{cons}}\mskip1.5mu\}}\par
\item \ensuremath{\Varid{avg}\comp \alt{\Varid{singl}}{\Varid{cons}}\mathrel{=}\alt{\Varid{b1}}{\Varid{q1}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length })}\par
\item \ensuremath{\length \comp \alt{\Varid{singl}}{\Varid{cons}}\mathrel{=}\alt{\Varid{b2}}{\Varid{q2}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length })}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Varid{fusão}\mathbin{-+}\Varid{lado}\;\Varid{esquerdo};\Varid{absorção}\mathbin{-+}\mskip1.5mu\}} \par
\item \ensuremath{\alt{\Varid{avg}\comp \Varid{singl}}{\Varid{avg}\comp \Varid{cons}}\mathrel{=}\alt{\Varid{b1}\comp \Varid{id}}{\Varid{q1}\comp \Varid{id}\times\conj{\Varid{avg}}{\length }}} \par
\item \ensuremath{\alt{\length \comp \Varid{singl}}{\length \comp \Varid{cons}}\mathrel{=}\alt{\Varid{b2}\comp \Varid{id}}{\Varid{q2}\comp \Varid{id}\times\conj{\Varid{avg}}{\length }}} \par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Natural}\mathbin{-}\Varid{id}\mskip1.5mu\}} \par
\item \ensuremath{\alt{\Varid{avg}\comp \Varid{singl}}{\Varid{avg}\comp \Varid{cons}}\mathrel{=}\alt{\Varid{b1}}{\Varid{q1}\comp \Varid{id}\times\conj{\Varid{avg}}{\length }}} \par
\item \ensuremath{\alt{\length \comp \Varid{singl}}{\length \comp \Varid{cons}}\mathrel{=}\alt{\Varid{b2}}{\Varid{q2}\comp \Varid{id}\times\conj{\Varid{avg}}{\length }}} \par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Eq}\mathbin{-+}\mskip1.5mu\}} \par
\item \ensuremath{\Varid{avg}\comp \Varid{singl}\mathrel{=}\Varid{b1}} \par
\item \ensuremath{\Varid{avg}\comp \Varid{cons}\mathrel{=}\Varid{q1}\comp \Varid{id}\times\conj{\Varid{avg}}{\length }} \par
\item \ensuremath{\length \comp \Varid{singl}\mathrel{=}\Varid{b2}} \par
\item \ensuremath{\length \comp \Varid{cons}\mathrel{=}\Varid{q2}\comp \Varid{id}\times\conj{\Varid{avg}}{\length }} \par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Def}\mathbin{-}\Varid{comp}\;\mathrm{2}\;\Varid{x}\mskip1.5mu\}} \par
\item \ensuremath{\Varid{avg}\;(\Varid{singl}\;\Varid{a})\mathrel{=}\Varid{b1}\;\Varid{a}} \par
\item \ensuremath{\Varid{avg}\;(\Varid{cons}\;(\Varid{a},\Varid{b}))\mathrel{=}\Varid{q1}\;(\Varid{id}\times\conj{\Varid{avg}}{\length })\;(\Varid{a},\Varid{b})} \par
\item \ensuremath{\length \;(\Varid{singl}\;\Varid{a})\mathrel{=}\Varid{b2}\;\Varid{a}} \par
\item \ensuremath{\length \;(\Varid{cons}\;(\Varid{a},\Varid{b}))\mathrel{=}\Varid{q2}\;(\Varid{id}\times\conj{\Varid{avg}}{\length })\;(\Varid{a},\Varid{b})} \par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Def}\mathbin{-}\Varid{x}\mskip1.5mu\}} \par
\item \ensuremath{\Varid{avg}\;(\Varid{singl}\;\Varid{a})\mathrel{=}\Varid{b1}\;\Varid{a}} \par
\item \ensuremath{\Varid{avg}\;(\Varid{cons}\;(\Varid{a},\Varid{b}))\mathrel{=}\Varid{q1}\;(\Varid{id}\;\Varid{a}\times\conj{\Varid{avg}}{\length }\;\Varid{b})} \par
\item \ensuremath{\length \;(\Varid{singl}\;\Varid{a})\mathrel{=}\Varid{b2}\;\Varid{a}} \par
\item \ensuremath{\length \;(\Varid{cons}\;(\Varid{a},\Varid{b}))\mathrel{=}\Varid{q2}\;(\Varid{id}\;\Varid{a}\times\conj{\Varid{avg}}{\length }\;\Varid{b})} \par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \mskip1.5mu\}} \par
\item \ensuremath{\Varid{avg}\;(\Varid{singl}\;\Varid{a})\mathrel{=}\Varid{b1}\;\Varid{a}} \par
\item \ensuremath{\Varid{avg}\;(\Varid{cons}\;(\Varid{a},\Varid{b}))\mathrel{=}\Varid{q1}\;(\Varid{a},(\Varid{avg}\;\Varid{b},\length \;\Varid{b}))} \par
\item \ensuremath{\length \;(\Varid{singl}\;\Varid{a})\mathrel{=}\Varid{b2}\;\Varid{a}} \par
\item \ensuremath{\length \;(\Varid{cons}\;(\Varid{a},\Varid{b}))\mathrel{=}\Varid{q2}\;(\Varid{a},(\Varid{avg}\;\Varid{b},\length \;\Varid{b}))} \par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \mskip1.5mu\}} \par 
\item \ensuremath{\Varid{avg}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}\Varid{b1}\;\Varid{a}} \par
\item \ensuremath{\Varid{avg}\;(\Varid{a}\mathbin{:}\Varid{b})\mathrel{=}\Varid{q1}\;(\Varid{a},(\Varid{avg}\;\Varid{b},\length \;\Varid{b}))} \par
\item \ensuremath{\length \;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}\Varid{b2}\;\Varid{a}} \par
\item \ensuremath{\length \;(\Varid{a}\mathbin{:}\Varid{b})\mathrel{=}\Varid{q2}\;(\Varid{a},(\Varid{avg}\;\Varid{b},\length \;\Varid{b}))} \par
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outList'}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[17]%
\>[17]{}\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outList'}\;(\Varid{a}\mathbin{:}\Varid{x}){}\<[17]%
\>[17]{}\mathrel{=}i_2\;(\Varid{a},\Varid{x}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataList'}\;\Varid{g}{}\<[15]%
\>[15]{}\mathrel{=}\Varid{g}\comp \Varid{recList'}\;(\Varid{cataList'}\;\Varid{g})\comp \Varid{outList'}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recList'}\;{}\<[11]%
\>[11]{}\Varid{f}{}\<[15]%
\>[15]{}\mathrel{=}\Varid{id}+\Varid{id}\times\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataList'}\;\Varid{gene\char95 aux}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{gene\char95 aux}\mathrel{=}\alt{\Varid{init}}{\Varid{loop}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{loop}\mathrel{=}\conj{\Varid{q1}}{\Varid{q2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{init}\mathrel{=}\conj{\Varid{b1}}{\Varid{b2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{b1}\;\Varid{n}\mathrel{=}\Varid{id}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{b2}\;\Varid{n}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{q1}\;(\Varid{a},(\Varid{avg\char95 b},\Varid{length\char95 b}))\mathrel{=}{}\<[32]%
\>[32]{}(\Varid{a}\mathbin{+}\Varid{avg\char95 b}\mathbin{*}\Varid{length\char95 b})\mathbin{/}(\Varid{length\char95 b}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{q2}\;(\Varid{a},(\Varid{avg\char95 b},\Varid{length\char95 b}))\mathrel{=}\Varid{length\char95 b}\mathbin{+}\mathrm{1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Listas}\mathbin{:}\Conid{F}\;\Varid{f}\mathrel{=}\Varid{id}\mathbin{+}\Varid{id}\;\Varid{f}\mskip1.5mu\}}\par
\item \ensuremath{\Varid{avg}\comp \mathbf{in}\mathrel{=}\alt{\Varid{b1}}{\Varid{q1}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{avg}}{\length }\mathbin{\uparrow}\mathrm{2})}\par
\item \ensuremath{\length \comp \mathbf{in}\mathrel{=}\alt{\Varid{b2}}{\Varid{q2}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{avg}}{\length }\mathbin{\uparrow}\mathrm{2})}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \mathbf{in}\mathrel{=}\alt{\Conid{Leaf}}{\Conid{Fork}}\mskip1.5mu\}}\par
\item \ensuremath{\Varid{avg}\comp \alt{\Conid{Leaf}}{\Conid{Fork}}\mathrel{=}\alt{\Varid{b1}}{\Varid{q1}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length })}\par
\item \ensuremath{\length \comp \alt{\Conid{Leaf}}{\Conid{Fork}}\mathrel{=}\alt{\Varid{b2}}{\Varid{q2}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length })}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Varid{fusão}\mathbin{-+}\Varid{lado}\;\Varid{esquerdo};\Varid{absorção}\mathbin{-+}\mskip1.5mu\}}\par
\item \ensuremath{\alt{\Varid{avg}\comp \Conid{Leaf}}{\Varid{avg}\comp \Conid{Fork}}\mathrel{=}\alt{\Varid{b1}\comp \Varid{id}}{\Varid{q1}\comp \conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length }}}\par
\item \ensuremath{\alt{\length \comp \Conid{Leaf}}{\length \comp \Conid{Fork}}\;\length \comp \alt{\Conid{Leaf}}{\Conid{Fork}}\mathrel{=}\alt{\Varid{b2}\comp \Varid{id}}{\Varid{q2}\comp \conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length }}}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Natural}\mathbin{-}\Varid{id}\mskip1.5mu\}}\par
\item \ensuremath{\alt{\Varid{avg}\comp \Conid{Leaf}}{\Varid{avg}\comp \Conid{Fork}}\mathrel{=}\alt{\Varid{b1}}{\Varid{q1}\comp \conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length }}}\par
\item \ensuremath{\alt{\length \comp \Conid{Leaf}}{\length \comp \Conid{Fork}}\;\length \comp \alt{\Conid{Leaf}}{\Conid{Fork}}\mathrel{=}\alt{\Varid{b2}}{\Varid{q2}\comp \conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length }}}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Eq}\mathbin{-+}\mskip1.5mu\}}\par
\item \ensuremath{\Varid{avg}\comp \Conid{Leaf}\mathrel{=}\Varid{b1}}\par
\item \ensuremath{\Varid{avg}\comp \Conid{Fork}\mathrel{=}\Varid{q1}\comp \conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length }}\par
\item \ensuremath{\length \comp \Conid{Leaf}\mathrel{=}\Varid{b2}}\par
\item \ensuremath{\length \comp \Conid{Fork}\mathrel{=}\Varid{q2}\comp \conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length }}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Def}\mathbin{-}\Varid{comp}\;\mathrm{2}\;\Varid{x}\mskip1.5mu\}}\par
\item \ensuremath{\Varid{avg}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{b1}\;\Varid{a}}\par
\item \ensuremath{\Varid{avg}\;(\Conid{Fork}\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{b}))\mathrel{=}\Varid{q1}\;(\conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length })\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{b})}\par
\item \ensuremath{\length \;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{b2}\;\Varid{a}}\par
\item \ensuremath{\length \;(\Conid{Fork}\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{b}))\mathrel{=}\Varid{q2}\;(\conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length })\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{b})}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \Conid{Def}\mathbin{-}\Varid{x}\mskip1.5mu\}}\par
\item \ensuremath{\Varid{avg}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{b1}\;\Varid{a}}\par
\item \ensuremath{\Varid{avg}\;(\Conid{Fork}\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{b}))\mathrel{=}\Varid{q1}\;(\conj{\Varid{avg}}{\length }\;(\mathsf{LTree}\;\Varid{a}),\conj{\Varid{avg}}{\length }\;(\mathsf{LTree}\;\Varid{b}))}\par
\item \ensuremath{\length \;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{b2}\;\Varid{a}}\par
\item \ensuremath{\length \;(\Conid{Fork}\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{b}))\mathrel{=}\Varid{q2}\;(\conj{\Varid{avg}}{\length }\;(\mathsf{LTree}\;\Varid{a}),\conj{\Varid{avg}}{\length }\;(\mathsf{LTree}\;\Varid{b}))}\par
\item
\item \equiv \ensuremath{\{\mskip1.5mu \mskip1.5mu\}}\par
\item \ensuremath{\Varid{avg}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{b1}\;\Varid{a}}\par
\item \ensuremath{\Varid{avg}\;(\Conid{Fork}\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{b}))\mathrel{=}\Varid{q1}\;((\Varid{avg}\;(\mathsf{LTree}\;\Varid{a}),\length \;(\mathsf{LTree}\;\Varid{a})),(\Varid{avg}\;(\mathsf{LTree}\;\Varid{b}),\length \;(\mathsf{LTree}\;\Varid{b})))}\par
\item \ensuremath{\length \;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{b2}\;\Varid{a}}\par
\item \ensuremath{\length \;(\Conid{Fork}\;(\mathsf{LTree}\;\Varid{a},\mathsf{LTree}\;\Varid{b}))\mathrel{=}\Varid{q2}\;((\Varid{avg}\;(\mathsf{LTree}\;\Varid{a}),\length \;(\mathsf{LTree}\;\Varid{a})),(\Varid{avg}\;(\mathsf{LTree}\;\Varid{b}),\length \;(\mathsf{LTree}\;\Varid{b})))}\par
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outLTree'}\;(\Conid{Leaf}\;\Varid{a}){}\<[22]%
\>[22]{}\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outLTree'}\;(\Conid{Fork}\;(\Varid{x},\Varid{y})){}\<[24]%
\>[24]{}\mathrel{=}i_2\;(\Varid{x},\Varid{y}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataLTree'}\;\Varid{g}{}\<[16]%
\>[16]{}\mathrel{=}\Varid{g}\comp \Varid{recLTree'}\;(\Varid{cataLTree'}\;\Varid{g})\comp \Varid{outLTree'}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recLTree'}\;{}\<[12]%
\>[12]{}\Varid{f}{}\<[16]%
\>[16]{}\mathrel{=}\Varid{id}+\Varid{f}\times\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avgLTree}\mathrel{=}\p1\comp \Varid{cataLTree'}\;\Varid{gene}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{gene}\mathrel{=}\alt{\Varid{init}}{\Varid{loop}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{loop}\mathrel{=}\conj{\Varid{q1}}{\Varid{q2}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{init}\mathrel{=}\conj{\Varid{b1}}{\Varid{b2}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{q1}\;((\Varid{aa},\Varid{al}),(\Varid{ba},\Varid{bl}))\mathrel{=}{}\<[29]%
\>[29]{}((\Varid{aa}\mathbin{*}\Varid{al})\mathbin{+}(\Varid{ba}\mathbin{*}\Varid{bl}))\mathbin{/}(\Varid{al}\mathbin{+}\Varid{bl}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{q2}\;((\Varid{aa},\Varid{al}),(\Varid{ba},\Varid{bl}))\mathrel{=}\Varid{al}\mathbin{+}\Varid{bl}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
