...
int main() {
    ...
    char clientsFilePath[256] = "src/DadosIniciais/Clientes.txt";
    char productsFilePath[256] = "src/DadosIniciais/Produtos.txt";
    char salesFilePath[256] = "src/DadosIniciais/Vendas_1M.txt";
