...
*/
SGV loadSGVFromFiles(SGV sgv, char* clientsFilePath, char* productsFilePath,
                     char* salesFilePath);
...
/**
@brief Função que vai buscar todas as vendas e faturaçao ocurridas num certo mes
por um produto(QUERY3)
@param Estrutura de Dados (SGV)
...
/**
@brief Função que vai buscar todos os produtos que nao foram vendidos (por
filiais ou geral) (QUERY4)
@param Estrutura de Dados (SGV)
...
/**
@brief Função que vai buscar todos os clientes que efetuaram compras em todas as
filias (QUERY5)
@param Estrutura de Dados (SGV)
*/
...
/**
@brief Função que vai calcular o numero de produtos e clientes que nao efetuaram
compras (QUERY6)
@param Estrutura de Dados (SGV)
*/
...
/**
@brief Função que vai buscar o numero de compras de um determinado cliente
(QUERY7)
@param Estrutura de Dados (SGV)
...
/**
@brief Função que vai buscar o numero de compras e a faturação num intervalo de
meses (QUERY8)
@param Estrutura de Dados (SGV)
@param Mes minimo
@param Mes maximo
...
/**
@brief Função que vai buscar os clientes que compraram um produto num certo
filial (QUERY9)
@param Estrutura de Dados (SGV)
...
/**
@brief Função que vai buscar os produtos comprados por um cliente num certo mes,
ordenando-os (QUERY10)
@param Estrutura de Dados (SGV)
...
/**
@brief Função que mostra a informaçao sobre a leitura dos files da primeira
query (QUERY13)
@param Estrutura de Dados (SGV)
@param Ficheiro dos clientes
@param Ficheiro dos produtos
...
*/
void showFilesInfo(SGV sgv, char* clientsFilePath, char* productsFilePath,
                   char* salesFilePath, float time);
