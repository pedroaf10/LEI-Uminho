...
utente(1,1234,'alice',data(1950,2,12), 'alice@gmail.com',935852315, 'Praceta Conde Arnoso 22 2635-240 FRANCOS', padeiro,[asma,bronquite], 1).
utente(2,1234,'paulo',data(2000,5,12), 'paulo@gmail.com',934209315, 'Rua Portas Água 2 6120-772 MATADOURO', carteiro,[rinite], 1). 
...
utente(4,1234,'tiago',data(1993,3,22), 'tiagoaf@gamil.com',965850111, 'R Capela 118 2410-433 LEIRIA', informatico,[], 1). 
utente(5,1234,'juliana',data(1965,5,23), 'juliana@gamil.com',960350178, 'Estrada Logo Deus 110 3720-568 IGREJA', medico,[], 1).
utente(6,1234,'alice almeida rodrigues',data(2000,8,19), 'alicearod@gamil.com',936950825, 'R Portela 94 3600-202 CASTRO DAIRE', militar,[], 1). 
utente(7,1234,'miguel carvalho',data(1994,9,4), 'miguelcarvalho@gamil.com',935621465, 'R Alto Eira 110 2745-758 QUELUZ', policia,[], 1). 
...
utente(9,1234,'pedro albino',data(1961,1,3), 'albinopedro@gamil.com',925856215, 'R Tomé B Queirós 118 4525-221 CANEDO', carpinteiro,[obesidade, 'doenca coronaria'], 1). 
utente(10,1234,'albertina maria',data(1959,8,24), 'mariaalbertina@gamil.com',925856565, 'Quinta Beloura 21 2714-521 PORTELA', costureira,[diabetes], 1).
utente(11,1234,'rita abreu',data(1954,2,10), 'ritaabreu@gamil.com',965256565, 'R Cimo Povo 47 4615-355 BORBA DE GODIM', farmaceutica,[], 1).
utente(12,1234,'alberto andrade',data(1929,9,30), 'andradealberto@gamil.com',965216165, 'Avenida Almirante Reis 81 2580-467 CARREGADO', reformado,[], 1).
utente(13,1234,'aline correia rodrigues',data(1969,5,19), 'jalberto@gamil.com',216950825, 'R Pescador Bacalhoeiro 78 4495-441 PÓVOA DE VARZIM', informatico,[dpoc], 1).
